...
public class BridgeUtil {
	...
	final static String JS_HANDLE_MESSAGE_FROM_JAVA = "javascript:JSBridge._handleMessageFromNative(%s);";
	final static String JS_FETCH_QUEUE_FROM_JAVA = "javascript:JSBridge._fetchQueue();";
